...
# 数据加载和预处理
dataset = pd.read_csv("../Week01/dataset.csv", sep="\t", header=None)  # 读取数据集文件
texts = dataset[0].tolist()  # 提取文本数据
string_labels = dataset[1].tolist()  # 提取文本标签
...
# 输入 '一加一等于几' 预测为: 'Other'
# 输入 '请帮我打开窗户' 预测为: 'HomeAppliance-Control'
