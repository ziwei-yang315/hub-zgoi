...
class GRUClassifier(nn.Module):
    ...
    def forward(self, x):
        ...
        # For classification, we typically use the last hidden state
        # GRU returns output of all timesteps and last hidden state
        # We take the last hidden state (similar to LSTM's hidden state)
